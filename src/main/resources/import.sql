...
INSERT INTO USUARIO (ID, DATA_CADASTRO, CPF, SENHA, NOME, EMAIL, ATIVADO) VALUES (1, now(), '111.111.111-11', '$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi', 'admin', 'admin@admin.com', true);
